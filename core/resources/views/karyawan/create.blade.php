...
<form action="{{ route('karyawan.store') }}" method="post" enctype="multipart/form-data" class="form-horizontal">
                    ...
                    <div class="card">
                      <div class="card-header">
                        <strong>Form Input</strong> Karyawan
                      </div>
                      <div class="card-body card-block">
                        
                          <div class="row form-group{{ $errors->has('pt') ? ' has-error' : '' }}">
                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">Perusahan</label></div>
                            <div class="col-12 col-md-9">
							<select name="pt" id="multiple-select" multiple="" class="form-control">
						  ...
						  <div class="row form-group">
                            <div class="col col-md-3"><label for="email-input" class=" form-control-label">Nama Karyawan</label></div>
