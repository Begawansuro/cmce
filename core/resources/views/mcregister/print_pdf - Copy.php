...
<table id="pseudo-demo">
     <thead>
	  @foreach($datas as $d)
	   ...
	   @endforeach
                        <tr>
                          <td rowspan="2"><div align="right"><img src="http://localhost/iro/public/inc/images/nnr2.png" alt="Logo"></div></td>
                          <td ><div align="left" class="F18"> NAUFAL NABILA ROSALIA</div></td>
                          <td rowspan="2"><div align="center">Barcode {{$data}}</div></td>
                        </tr>
                        <tr>
                          <td><div align="left" class="F18"> LABORATORIUM NNR MEDIKA</div></td>
                        </tr>
                      </thead>
                      <tbody>
                      </tbody>
 ...
 <table id="pseudo-demo">
     <thead>
						...
						<tr>
						  ...
						  <td width="30%">:</td>
						  <td width="13%"></td>
						  <td colspan="2" rowspan="2"><div align="center">Paket : A </div></td>
	   </tr>
						<tr>
						  <td>&nbsp;</td>
						  <td>Nama</td>
